...
namespace DSEU.UI.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private const string AppName = "Netije";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", IdentityResources.VerificationCodeIsInvalid);
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            StatusMessage = IdentityResources.YourAuthenticatorAppHasBeenVerified;
