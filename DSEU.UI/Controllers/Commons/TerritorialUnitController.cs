...
namespace DSEU.UI.Controllers.Commons
{
    ...
    public class TerritorialUnitController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] CreateTerritorialUnitComand createTerritorial)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] UpdateTerritorialUnitCommand command)
        {
            if (id != command.Id)
            {
