    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationalUnitType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationalUnit_OrganizationalUnitType_TypeId",
                        column: x => x.TypeId,
                        principalTable: "OrganizationalUnitType",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Immutable = table.Column<bool>(type: "boolean", nullable: true),
                    IsSingleUser = table.Column<bool>(type: "boolean", nullable: true),
                    LoginId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    PersonalPhoto = table.Column<byte[]>(type: "bytea", nullable: true),
                    PersonalPhotoHash = table.Column<string>(type: "text", nullable: true),
                    FirstName = table.Column<string>(type: "text", nullable: true),
                    LastName = table.Column<string>(type: "text", nullable: true),
                    MiddleName = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recipient_JobTitle_JobTitleId",
                        column: x => x.JobTitleId,
                        principalTable: "JobTitle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Recipient_Login_LoginId",
                        column: x => x.LoginId,
                        principalTable: "Login",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Recipient_OrganizationalUnit_OrganizationalUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationalUnit_TypeId",
                table: "OrganizationalUnit",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipient_Description",
                table: "Recipient",
                column: "Description");

            migrationBuilder.CreateIndex(
                name: "IX_Recipient_JobTitleId",
                table: "Recipient",
                column: "JobTitleId");

            migrationBuilder.CreateIndex(
                name: "IX_Recipient_LoginId",
                table: "Recipient",
                column: "LoginId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Recipient_Name",
                table: "Recipient",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_Recipient_OrganizationalUnitId",
                table: "Recipient",
